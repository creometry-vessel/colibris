...
public class ListCreation extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IUser.getmycreation(Integer.parseInt(string)).enqueue(new Callback<List<Evenement>>() {
            @Override
            public void onResponse(Call<List<Evenement>> call, Response<List<Evenement>> response) {

                if (response.isSuccessful()) {
                    me = new ArrayList<>(response.body());
                    ev = new CreationAdapter(ListCreation.this, me);
                    rc.setAdapter(ev);
...
/*
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.itemhome:
                Intent i = new Intent(ListCreation.this, AccueilDonneur.class);
            ...
            case R.id.itemevenement:
                Intent i1 = new Intent(ListCreation.this, ListEvenement.class);
                startActivity(i1);
                break;
            case R.id.itemprofile:
                Intent i2 = new Intent(ListCreation.this, Profildonneur.class);
                Toast.makeText(getApplicationContext(), "profil", Toast.LENGTH_SHORT).show();
                startActivity(i2);
                break;

            case R.id.itemcode:
                Intent i4 = new Intent(ListCreation.this, qrcode.class);
                Toast.makeText(getApplicationContext(), "Qrcode", Toast.LENGTH_SHORT).show();
                startActivity(i4);
                break;
            case R.id.itemscore:
                Intent i5 = new Intent(ListCreation.this, Score.class);
                Toast.makeText(getApplicationContext(), "Qrcode", Toast.LENGTH_SHORT).show();
                startActivity(i5);
                break;
            case R.id.itemsponsor:
                Intent i6 = new Intent(ListCreation.this, ListSponsor.class);
                Toast.makeText(getApplicationContext(), "Qrcode", Toast.LENGTH_SHORT).show();
                startActivity(i6);
                break;
            case R.id.itemlogout:
                Intent intent = new Intent(ListCreation.this, login.class)
