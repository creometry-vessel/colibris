...
public class info_from_map extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_from_map);
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.v("yheiddonnation", "wegetit" + y);
                Intent intent = new Intent(v.getContext(), Infodetails.class);
                intent.putExtra("id_donneur",y);
        ...
        IUser.getdonnationfromadresse(Integer.parseInt(ff)).enqueue(new Callback<List<Map>>(){
            @Override
            public void onResponse(Call<List<Map>> call, Response<List<Map>> response) {

                if (response.isSuccessful()) {
                    me = new ArrayList<>(response.body());
                    ev = new InfoAdapter(info_from_map.this, me);
                    rc.setAdapter(ev);
